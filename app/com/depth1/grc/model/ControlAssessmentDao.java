...
public interface ControlAssessmentDao {
	 ...
	 */
	public void createControlAssessment(ControlAssessment assessment) throws DaoException;
	 ...
	 */
	public ControlAssessment getControlAssessment(long assessmentId, long tenantId) throws DaoException;
	 ...
	 */
	public ControlAssessment getControlAssessment(long assessmentId) throws DaoException;	
	 ...
	 */
	public List<ControlAssessment> listControlAssessment(long tenantId) throws DaoException;
	 ...
	 * @throws DaoException if error occurs while finding control assessment in the data store
	 */
	public List<ControlAssessment> listControlAssessment(long assessmentId, long tenantId) throws DaoException;	
	 ...
	 */
	public boolean updateControlAssessment(ControlAssessment control) throws DaoException; 	
