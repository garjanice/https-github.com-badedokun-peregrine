...
public class CassandraInfoProtocolDao implements InfoProtocolDao {
	...
	public void createInfoProtocol(InfoProtocol infoProtocol) throws DaoException {
		...
		try {					
			/*
 			from risk assessment, change for infoProtocol
			Statement insert = QueryBuilder
			
					.insertInto("grc", "infoprotocol")
	...
	public boolean deleteInfoProtocol(InfoProtocol infoProtocol) throws DaoException {
        ...
        try {
        	/*
            Delete.Where delete = QueryBuilder.delete().from("grc", "infoprotocol")
                    .where(eq("id", infoProtocol.getAssessmentId()));
	...
	public List<InfoProtocol> listInfoProtocol() throws DaoException {
        List<InfoProtocol> listIP = new ArrayList<>();
        Session dbSession = CassandraDaoFactory.connect();
        try {
        	/*
            Statement listAllRA = QueryBuilder.select().all()
                    .from("grc", "infoprotocol");
